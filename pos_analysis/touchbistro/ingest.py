...
# TouchBistro-specific configuration
# Note: These defaults can be overridden per client
...
PST_RATE_ALCOHOL: float = 0.10  # BC alcohol tax
...
def load_detailed_sales(data_dir: Path = None) -> pd.DataFrame:
    """
...
def load_item_totals(data_dir: Path = None) -> pd.DataFrame:
    """
...
def load_shifts(data_dir: Path = None) -> pd.DataFrame:
    """
...
def load_delivery(data_dir: Path = None) -> pd.DataFrame:
    """
...
def load_reservations(data_dir: Path = None) -> pd.DataFrame:
    """
...
def load_payments(data_dir: Path = None) -> pd.DataFrame:
    """
