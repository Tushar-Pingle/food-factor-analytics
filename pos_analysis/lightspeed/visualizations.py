...
from config.brand import (
    ...
    AXIS_FONT_SIZE as CHART_FONT_SIZE, TITLE_FONT_SIZE,
    TICK_FONT_SIZE as ANNOTATION_FONT_SIZE, DEFAULT_WIDTH as CHART_WIDTH,
    DEFAULT_HEIGHT as CHART_HEIGHT, get_plotly_template,
)
from config.settings import BENCHMARKS

# Chart export settings
CHART_SCALE = 2  # 2x resolution for high-quality PDF output
CHART_FORMAT = "png"  # Export format for charts
